...
/**
 * Utility methods for converting between different representations of MMSI
 * identifiers and for searching lists of Maritime Cloud services based on MMSI
 */
public class MaritimeCloudUtils {
	...
	public static boolean isSTCC(MaritimeId id) {
		return id != null
				&& id.toString().startsWith("mmsi://" + STCC_MMSI_PREFIX);
	}

	/**
	 * Returns if the given maritime id is from a ship, i.e. not from a sea
	 ...
	 */
	public static <E, T> ServiceEndpoint<E, T> findServiceWithMmsi(
			List<ServiceEndpoint<E, T>> serviceList, long mmsi) {
	 ...
	 * @return the matching service or null if not found
	 */
	public static <E, T> ServiceEndpoint<E, T> findServiceWithId(
			List<ServiceEndpoint<E, T>> serviceList, MaritimeId id) {
		if (serviceList != null) {
	 ...
	 */
	public static <E, T> ServiceEndpoint<E, T> findSTCCService(
			List<ServiceEndpoint<E, T>> serviceList) {
		if (serviceList != null) {
			for (ServiceEndpoint<E, T> service : serviceList) {
	 ...
	 */
	public static <E, T> List<ServiceEndpoint<E, T>> findSTCCServices(
			List<ServiceEndpoint<E, T>> serviceList) {
